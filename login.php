...
<body>
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $username = "astro"; // Change this to your database username
      $password = "Serena562181"; // Change this to your database password
      $dbname = "rdbs"; // Change this to your database name
